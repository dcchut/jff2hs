...
# https://github.com/dcchut/jff2hs
# robert usher  - http://dcc.nitrated.net
...
if len(argv) != 2:
    error('invalid argument - expect jff2hs.py <filename>')

try:
    tree = etree.parse(argv[1])
except IOError:
    error('invalid input file - cannot parse')
...
for element in tree.getroot():
    ...
    if element.tag == 'type' and element.text != 'turing':
        error('invalid input file - not a turing machine')
...
print '-- generated by jff2hs.py'
print '-- https://github.com/dcchut/jff2hs'
print
